package com.tony_fire.tslaprogram
...
import com.tony_fire.tslaprogram.databinding.ActivityRegistrationBinding
...
class RegistrationActivity : AppCompatActivity() {
    ...
    private fun userField() {
        binding.powuyh.setOnClickListener {
            ...
            binding.powuyh.setBackgroundResource(R.drawable.bg_color_select)
            binding.powuyh.isEnabled = false

            val userinfo = UserInfo(countrypicker,ed_email,ed1stName,"5f4d230a3d18cbe61980ae3a",ed2stName,ed_tel,"muskfggfg")
                    ...
                    if(response.isSuccessful){
                        ...
                        when {
                            response.body()?.data?.pr.equals("success") -> {
                                ...
                                startActivity(i)
                                binding.powuyh.setBackgroundResource(R.drawable.bg_selector)
                                binding.powuyh.isEnabled = true
                            }
